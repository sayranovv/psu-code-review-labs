...
/**
 * город с расширенным сравнением дорожной сети.
 */
public class City_2_6_5 {
	 ...
	 */
	public City_2_6_5(final String name) {
		validateName(name);
		this.name = name;
	...
	public City_2_6_5(
		final String name,
		final Map<City_2_6_5, Integer> initialPaths
	) {
		validateName(name);
		...
		for (
			Map.Entry<City_2_6_5, Integer> entry
	 ...
	 */
	public void addPath(final City_2_6_5 city, final int cost) {
		validateCity(city);
		validateCost(cost);
	 ...
	 * @param city соседний город
	 */
	public void removePath(final City_2_6_5 city) {
		if (city == null) {
			throw new IllegalArgumentException(
	...
	public boolean equals(final Object object) {
		...
		if (!(object instanceof City_2_6_5 other)) {
			return false;
		}

		return normalizedPaths().equals(other.normalizedPaths());
	}

	@Override
	public int hashCode() {
		return Objects.hash(normalizedPaths());
	}

	/**
	 * формирует нормализованное представление дорог.
	 *
	 * @return отсортированная карта соседей
	 */
	private Map<String, Integer> normalizedPaths() {
	 ...
	 */
	private void validateCity(final City_2_6_5 city) {
		if (city == null) {
			throw new IllegalArgumentException(
				"город не может быть null"
			);
