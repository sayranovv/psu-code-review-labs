...
/**
 * неизменяемая дробь для задания 2.1.4.
 */
public class Fraction_2_1_4 {
	 ...
	 */
	public Fraction_2_1_4 minus(final Fraction_2_1_4 other) {
		validateFraction(other);
		final int newNumerator =
			numerator * other.denominator
				- other.numerator * denominator;
	 ...
	 * @return результат вычитания
	 */
	public Fraction_2_1_4 minus(final int value) {
		return minus(new Fraction_2_1_4(value, 1));
	}
	 ...
	 */
	public Fraction_2_1_4 multiply(final Fraction_2_1_4 other) {
		validateFraction(other);
		return new Fraction_2_1_4(
	 ...
	 * @return результат умножения
	 */
	public Fraction_2_1_4 multiply(final int value) {
		return new Fraction_2_1_4(numerator * value, denominator);
	}
	 ...
	 */
	public Fraction_2_1_4 div(final Fraction_2_1_4 other) {
		validateFraction(other);
	 ...
	 * @return результат деления
	 */
	public Fraction_2_1_4 div(final int value) {
		if (value == 0) {
			throw new IllegalArgumentException(
				"деление на ноль невозможно"
			);
		...
		return new Fraction_2_1_4(numerator, denominator * value);
	}
